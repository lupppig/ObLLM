...
export class PromptBuilder {
	...
	buildConversationPrompt(
		...
		const system = [
			...
			'4. Agency (Implement): You can suggest creating new notes. When you want to propose a new note to the user, use this exact JSON format at the END of your message:',
			'',
			'```json',
			'{',
			'  "action": "create_note",',
